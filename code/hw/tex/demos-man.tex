\documentclass[a4paper]{article}%\usepackage{geometry}
%\usepackage{textcomp}
%\usepackage{amsmath}
\usepackage{tikz}
\usepackage{pgfplots}
\usetikzlibrary{arrows,shapes.gates.logic.US,shapes.gates.logic.IEC,calc,patterns}
...
\maketitle
\begin{abstract}
This is the Demos manual.
\end{abstract}

\section{Runtime Information}
The runtime information is in three tables.
