...
namespace Cilcc
{
  ...
  { 
    ...
    //      and by Reflection) 
    var GenericParamConstraintTable = 0x2C;
    ...
    var ManifestResourceTable = 0x28;
    // *Offset (a 4-byte constant) 
    ...
    var ModuleRefTable = 0x1A;
    // *Name (an index into the String he ap) 
    var NestedClassTable = 0x29;
    ...
    var StandAloneSigTable = 0x11;
    // *Signature (an index into the Blob heap) 
    var TypeDefTable = 0x02;
    // *Flags (a 4-byte bitmask of type TypeAttributes, §II.23.1.15) 
    // *TypeName (an index into the String heap) 
    // *TypeNamespace (an index into the String heap) 
    ...
    struct TypeDefTableRec 
    { 
      int _index; // index in the TypeDefTable (0 is the pseudo class)
      uint Flag; 
      ushort TypeName; 
      string TypeNameStr;
      short TypeNamespace;
      string TypeNamespaceStr;
      short Extends; 
      short FieldList; 
      short MethodList;
    }
